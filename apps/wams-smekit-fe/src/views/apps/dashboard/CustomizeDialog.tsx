...
const CustomizeDialog: React.FC<CustomizeDialogProps> = ({ open, onClose, layout, setLayout }) => {
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          <Icon icon='mdi:view-dashboard-edit' width={28} style={{ color: theme.palette.primary.main }} />
            ...
            <React.Fragment key={widget.id}>
              <ListItem
                ...
                sx={{
                  p: 0,
                  cursor: 'grab',
                  bgcolor: draggedWidget === widget.id ? alpha(theme.palette.primary.main, 0.05) : 'inherit',
              ...
              >
                <Paper
                  ...
                  sx={{
                    ...
                    alignItems: 'center',
                    border: `1px solid ${
                      widget.visible ? alpha(theme.palette.primary.main, 0.2) : alpha(theme.palette.divider, 0.1)
                    }`,
                    bgcolor: widget.visible
                      ? alpha(theme.palette.background.paper, 1)
                      : alpha(theme.palette.action.disabledBackground, 0.1),
                    '&:hover': {
                      bgcolor: alpha(widget.visible ? theme.palette.primary.main : theme.palette.action.hover, 0.07)
                    }
                  }}
                >
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        color: widget.visible ? theme.palette.primary.main : theme.palette.text.secondary
                      }}
                    >
                    ...
                    <Box>
                      <Typography
                        ...
                        sx={{
                          fontWeight: 600,
                          color: widget.visible ? theme.palette.text.primary : theme.palette.text.secondary
                        }}
                      >
                        {widget.title}
                      </Typography>
              ...
              {index < widgets.length - 1 && <Divider variant='middle' sx={{ opacity: 0.6, mx: 4 }} />}
            </React.Fragment>
          ))}
        </List>
      </DialogContent>
