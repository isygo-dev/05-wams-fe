...
const RecentTemplatesWidget: React.FC<RecentTemplatesWidgetProps> = ({ templates, denseMode, onRefresh }) => {
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', flex: 1 }}>
                  <Avatar
                    sx={{
                      ...
                      color: template.status === 'active' ? theme.palette.success.main : theme.palette.warning.main
                    }}
                  >
                    <Icon
