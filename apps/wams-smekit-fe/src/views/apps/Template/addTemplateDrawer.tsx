...
const AddTemplateDrawer = ({ categoryTemplate, showDialogue, setShowDialogue }) => {
  ...
  const addTemplateMutation = useMutation({
    ...
    onSuccess: newTemplate => {
      ...
      queryClient.setQueryData('categoryTemplate', (old: CategoryTemplateType[] = []) => [...old, completeTemplate])
  ...
  const updateTemplateMutation = useMutation({
    ...
    onSuccess: updatedTemplate => {
      ...
      queryClient.setQueryData('categoryTemplate', (old: CategoryTemplateType[] = []) =>
        old.map(item => (item.id === updatedTemplate.id ? { ...updatedTemplate, author, category } : item))
      )
      ...
      <Box sx={{ p: 6 }}>
        <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <FileUploadContainer>
                  ...
                  <Typography variant='body2' sx={{ mt: 1, color: 'text.secondary' }}>
                    {file
                      ? file.name
                      : isEditMode
                      ? t('Upload new file (optional)')
                      : t('Click to browse (.pdf, .doc, .docx)')}
                  </Typography>
                  {file && (
                    <Button
                      size='small'
          ...
          <FormControl fullWidth sx={{ mb: 4 }} size='small'>
            ...
            />
            {errors.authorId && (
              <FormHelperText sx={{ color: 'error.main' }}>{errors.authorId?.message}</FormHelperText>
            )}
          </FormControl>
          ...
          <FormControl fullWidth sx={{ mb: 4 }} size='small'>
            ...
            />
            {errors.typeTs && <FormHelperText sx={{ color: 'error.main' }}>{errors.typeTs?.message}</FormHelperText>}
          </FormControl>
          ...
          <FormControl fullWidth sx={{ mb: 4 }} size='small'>
            ...
            />
            {errors.typeTl && <FormHelperText sx={{ color: 'error.main' }}>{errors.typeTl?.message}</FormHelperText>}
          </FormControl>
