...
import SliderBasic from 'template-shared/views/forms/form-elements/slider/SliderBasic'
import SliderRange from 'template-shared/views/forms/form-elements/slider/SliderRange'
import SliderSizes from 'template-shared/views/forms/form-elements/slider/SliderSizes'
import SliderColors from 'template-shared/views/forms/form-elements/slider/SliderColors'
import SliderDiscrete from 'template-shared/views/forms/form-elements/slider/SliderDiscrete'
import SliderVertical from 'template-shared/views/forms/form-elements/slider/SliderVertical'
import SliderSmallSteps from 'template-shared/views/forms/form-elements/slider/SliderSmallSteps'
import SliderCustomized from 'template-shared/views/forms/form-elements/slider/SliderCustomized'
import SliderCustomMarks from 'template-shared/views/forms/form-elements/slider/SliderCustomMarks'
import SliderCustomColors from 'template-shared/views/forms/form-elements/slider/SliderCustomColors'
import SliderRemovedTrack from 'template-shared/views/forms/form-elements/slider/SliderRemovedTrack'
import SliderInvertedTrack from 'template-shared/views/forms/form-elements/slider/SliderInvertedTrack'
import SliderMinimumDistance from 'template-shared/views/forms/form-elements/slider/SliderMinimumDistance'
import SliderRestrictedValues from 'template-shared/views/forms/form-elements/slider/SliderRestrictedValues'
import SliderLabelAlwaysVisible from 'template-shared/views/forms/form-elements/slider/SliderLabelAlwaysVisible'
import SliderControlledUncontrolled from 'template-shared/views/forms/form-elements/slider/SliderControlledUncontrolled'

// ** Source code imports
import * as source from 'template-shared/views/forms/form-elements/slider/SliderSourceCode'
