...
import CheckboxesBasic from 'template-shared/views/forms/form-elements/checkbox/CheckboxesBasic'
import CheckboxesSizes from 'template-shared/views/forms/form-elements/checkbox/CheckboxesSizes'
import CheckboxesColors from 'template-shared/views/forms/form-elements/checkbox/CheckboxesColors'
import CheckboxesShowError from 'template-shared/views/forms/form-elements/checkbox/CheckboxesShowError'
import CheckboxesCustomized from 'template-shared/views/forms/form-elements/checkbox/CheckboxesCustomized'
import CheckboxesCustomIcons from 'template-shared/views/forms/form-elements/checkbox/CheckboxesCustomIcons'
import CheckboxesLabelPlacement from 'template-shared/views/forms/form-elements/checkbox/CheckboxesLabelPlacement'
import CheckboxesControlledUncontrolled from 'template-shared/views/forms/form-elements/checkbox/CheckboxesControlledUncontrolled'

// ** Source code imports
import * as source from 'template-shared/views/forms/form-elements/checkbox/CheckboxesSourceCode'
