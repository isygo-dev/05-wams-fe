...
import PickersTime from 'template-shared/views/forms/form-elements/pickers/PickersTime'
import PickersBasic from 'template-shared/views/forms/form-elements/pickers/PickersBasic'
import PickersRange from 'template-shared/views/forms/form-elements/pickers/PickersRange'
import PickersMinMax from 'template-shared/views/forms/form-elements/pickers/PickersMinMax'
import PickersLocale from 'template-shared/views/forms/form-elements/pickers/PickersLocale'
import PickersOptions from 'template-shared/views/forms/form-elements/pickers/PickersOptions'
import PickersCallbacks from 'template-shared/views/forms/form-elements/pickers/PickersCallbacks'
import PickersSpecificRange from 'template-shared/views/forms/form-elements/pickers/PickersSpecificRange'
import PickersCustomization from 'template-shared/views/forms/form-elements/pickers/PickersCustomization'
import PickersIncludeExclude from 'template-shared/views/forms/form-elements/pickers/PickersIncludeExclude'
import PickersMonthYearQuarter from 'template-shared/views/forms/form-elements/pickers/PickersMonthYearQuarter'
import PickersMonthYearDropdowns from 'template-shared/views/forms/form-elements/pickers/PickersMonthYearDropdowns'

// ** Source code imports
import * as source from 'template-shared/views/forms/form-elements/pickers/PickersSourceCode'
