...
// ** Demo Imports
import FooterIllustrationsV2 from 'template-shared/views/pages/auth/FooterIllustrationsV2'
                  ...
                  endAdornment={
                    <InputAdornment position='end'>
                      ...
                      >
                        <Icon
                          icon={
                            showPassword ? 'fluent:slide-text-edit-24-regular' : 'fluent:slide-text-edit-24-regular-off'
                          }
                          fontSize={20}
                        />
                      </IconButton>
