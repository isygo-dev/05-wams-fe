...
import TenantsPage from 'template-shared/views/pages/auth/email-accounts-page/UserEmailAccounts'
...
// ** Layout Assignment
Tenants.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>

// ** Guard Assignment
Tenants.guestGuard = true
