        ...
        action={
          <>
            <Box sx={{display: 'flex', alignItems: 'flex-end', padding: '.05rem'}}>
              {checkPermission(PermissionApplication.INTEGRATION, PermissionPage.INTEGRATION_ORDER, PermissionAction.DELETE) ? (
              ...
              {checkPermission(PermissionApplication.INTEGRATION, PermissionPage.INTEGRATION_ORDER, PermissionAction.WRITE) ? (
