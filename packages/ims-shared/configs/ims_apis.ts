...
const imsApiUrls = {
  ...
  apiUrl_IMS_Tenant_EndPoint: apiUrl_IMS + api_version + '/private/tenant',
  apiUrl_IMS_Tenant_Count_EndPoint: apiUrl_IMS + api_version + '/private/tenant/count',
  apiUrl_IMS_Tenant_UpdateStatus_EndPoint: apiUrl_IMS + api_version + '/private/tenant/update-status',
  apiUrl_IMS_RoleInfo_EndPoint: apiUrl_IMS + api_version + '/private/roleInfo',
  apiUrl_IMS_RoleInfo_TenantDefault_EndPoint: apiUrl_IMS + api_version + '/private/roleInfo/default',
  apiUrl_IMS_Tenant_Image_EndPoint: apiUrl_IMS + api_version + '/private/tenant/image',
  apiUrl_IMS_Tenant_ImageDownload_EndPoint: apiUrl_IMS + api_version + '/private/tenant/image/download',
  apiUrl_IMS_Tenant_ImageUpload_EndPoint: apiUrl_IMS + api_version + '/private/tenant/image/upload',
  apiUrl_IMS_Tenant_Names_EndPoint: apiUrl_IMS + api_version + '/private/tenant/names',
  apiUrl_IMS_Tenant_Social_EndPoint: apiUrl_IMS + api_version + '/private/tenant/social',
  ...
  apiUrl_IMS_AccountsBySenderTenant_EndPoint: apiUrl_IMS + api_version + '/private/account/tenant/sender',
  apiUrl_IMS_AccountsStatusByTenant_EndPoint: apiUrl_IMS + api_version + '/private/account/chat/tenant',
  ...
  apiUrl_IMS_AccountAdminTenant_EndPoint: apiUrl_IMS + api_version + '/private/account/admin',
  apiUrl_IMS_UsersByTenant_EndPoint: apiUrl_IMS + api_version + '/private/account/tenant',
