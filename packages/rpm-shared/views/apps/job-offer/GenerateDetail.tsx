...
const GenerateDetail = (props: Props) => {
  ...
  const { data: jobData, isLoading: isLoadingJobDetail } = useQuery(
    ['jobData', id],
    () => JobOfferApis(t).getJobOfferById(id),
    {}
  )
  ...
  const { data: jobOfferList } = useQuery([`jobOfferList`, resumeCode], () =>
    JobOfferApis(t).getJobOffersNotAssignedToResume(resumeCode)
  )
          ...
          <div>
            <Card className='pdfPage'>
              <CardContent id='divToDownload' ref={pdfRef}>
                <Grid container>
                  <Grid item xs={12}>
                    <img src='/images/favicon-vertical-logo.png' width='169px' alt='logo' />
                  </Grid>
                </Grid>
                <Divider />
                ...
                <Grid container>
                  ...
                  <Grid item xs={12} sx={{ mt: 4 }}>
                    <Typography className='subtitle-pdf-job' sx={{ display: 'flex', alignItems: 'center' }}>
                      <Icon
                      ...
                      <TableBody sx={{ '& .MuiTableCell-root': { py: `${theme.spacing(1)} !important` } }}>
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Working_Mode')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                            ...
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Availability')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>
                        ...
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Contract_Type')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>
                            ...
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Location')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>
                        ...
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            {jobData?.details?.contractInfo?.salaryMin ? (
                              <Grid item md={6}>
                                <MUITableCell>
                                  <Typography className='subtitle-pdf-job'>{t('Job.Salary_Min')} :</Typography>
                                </MUITableCell>
                                <MUITableCell>
                                  <Typography className='text-pdf-job'>
                                    {jobData?.details?.contractInfo?.salaryMin}
                            ...
                            {jobData?.details?.contractInfo?.salaryMax ? (
                              <Grid item md={6}>
                                <MUITableCell>
                                  <Typography className='subtitle-pdf-job'>{t('Job.Salary_Max')} :</Typography>
                                </MUITableCell>
                                <MUITableCell>
                                  <Typography className='text-pdf-job'>
                                    {jobData?.details?.contractInfo?.salaryMax}
                      ...
                      <TableBody sx={{ '& .MuiTableCell-root': { py: `${theme.spacing(1)} !important` } }}>
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Customer')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>{jobData.customer}</Typography>
                              </MUITableCell>
                            </Grid>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Owner')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>{jobData.owner}</Typography>
                              </MUITableCell>
                            </Grid>
                          </Grid>
                        </TableRow>
                        ...
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            {jobData?.details?.jobInfo?.startDate ? (
                              <Grid item md={4}>
                                <MUITableCell>
                                  <Typography className='subtitle-pdf-job'>{t('start_date')} :</Typography>
                                </MUITableCell>
                                <MUITableCell>
                                  <Typography className='text-pdf-job'>
                            ...
                            {jobData?.details?.jobInfo?.endDate ? (
                              <Grid item md={4}>
                                <MUITableCell>
                                  <Typography className='subtitle-pdf-job'>{t('end_date')} :</Typography>
                                </MUITableCell>
                                <MUITableCell>
                                  <Typography className='text-pdf-job'>
                            ...
                            {jobData?.details?.jobInfo?.deadline ? (
                              <Grid item md={4}>
                                <MUITableCell>
                                  <Typography className='subtitle-pdf-job'>{t('deadline')} :</Typography>
                                </MUITableCell>
                                <MUITableCell>
                                  <Typography className='text-pdf-job'>
                        ...
                        <TableRow>
                          <Grid container md={12} sx={{ ml: 4, mt: 2 }}>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Positions')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>{jobData?.details?.jobInfo?.position}</Typography>
                              </MUITableCell>
                            </Grid>
                            <Grid item md={6}>
                              <MUITableCell>
                                <Typography className='subtitle-pdf-job'>{t('Job.Experience')} :</Typography>
                              </MUITableCell>
                              <MUITableCell>
                                <Typography className='text-pdf-job'>
