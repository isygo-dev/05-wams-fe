      ...
      <Grid container>
        ...
        <Grid item md={12}>
          <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Grid item xs={12} sx={{ mt: 2 }}>
                    {checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && (
                      <Button
                        ...
                        size={'small'}
                      >
                        <Icon icon='tabler:plus' style={{ marginRight: '6px' }} /> {t('Job.Add_Responsibility')}
                      </Button>
                    )}
                  </Grid>
                </Grid>
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControl fullWidth>
                      <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                          <TextField label={t('Job.Positions')} {...field} fullWidth variant='outlined' size='small' />
                        )}
                      />
                    </FormControl>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={9}>
                    <FormControl fullWidth>
                      <Controller
                        ...
                        rules={{ required: true }}
                        render={({ field: { value, onChange } }) => (
                          <MuiChipsInput size='small' value={value || []} label='Qualifications' onChange={onChange} />
                        )}
                      />
                    </FormControl>
                  </Grid>
                ...
                <Grid container spacing={4} sx={{ mt: 4 }}>
                  ...
                  <Grid item xs={12} sm={3}>
                    <FormControl fullWidth>
                      ...
                      />
                      {errors.details?.contractInfo?.contract && <p>{errors.details.contractInfo.contract.message}</p>}
                    </FormControl>
                  </Grid>
                  <Grid item xs={12} sm={3}>
                    <FormControl fullWidth>
            ...
            <ShareJobDrawer open={dialogShare} setOpen={setDialogShare} job={editedData} setJob={setJobSharedInfo} />
            <TemplateJobDrawer
