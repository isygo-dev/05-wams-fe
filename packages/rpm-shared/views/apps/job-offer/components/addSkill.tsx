                                ...
                                render={({field: {onChange, value}}) => (
                                    <Switch
                                        ...
                                        onChange={e => {
                                            ...
                                            checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && handleSkillChange(type, index, 'isMandatory', e.target.checked)
                                        }}
                                    />
                                )}
                            />
                ...
                <Controller
                    ...
                    render={({field: {onChange, value}}) => (
                        <TextField
                            ...
                            onChange={e => {
                                checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && onChange(e);
                                checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && handleSkillChange(type, index, 'name', e.target.value)
                            }}
                            fullWidth
                            variant='outlined'
                        />
                    ...
                    render={({field: {onChange, value}}) => (
                        <FormControl size='small' sx={{width: '90%'}}>
                            ...
                            <Select
                                ...
                                onChange={e => {
                                    checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && onChange(e);
                                    checkPermission(PermissionApplication.RPM, PermissionPage.JOB_OFFER, PermissionAction.WRITE) && handleSkillChange(type, index, 'level', e.target.value)
                                }}
                                fullWidth
                                variant='outlined'
                                label='Level'
