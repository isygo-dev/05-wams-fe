...
const CommonJobList = () => {
  ...
  const { data: jobs, isLoading } = useQuery(`jobs`, () =>
    JobOfferApis(t).getJobOffersByPage(paginationModel.page, paginationModel.pageSize)
  )
  const { data: countJobs, isLoading: isLoadingCountJobs } = useQuery(`countJobs`, () =>
    JobOfferApis(t).getJobOffersCount()
  )
  const { data: template, isLoading: isLoadingTemplate } = useQuery(`jobTemplates`, () =>
    JobOfferTemplateApis(t).getJobOfferTemplates()
  )
