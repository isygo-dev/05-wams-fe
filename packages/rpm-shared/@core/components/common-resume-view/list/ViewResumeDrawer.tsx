          ...
          <Grid container spacing={2} justifyContent='space-between' alignItems='stretch'>
            <Grid item sm={12} md={2} xs={12}>
              <PictureCard
                photoFile={photoFile}
                openImageEdit={
                  checkPermission(PermissionApplication.RPM, PermissionPage.RESUME_IMAGE, PermissionAction.WRITE) &&
                  openImageEdit
                }
                url={
                  checkPermission(PermissionApplication.RPM, PermissionPage.RESUME_IMAGE, PermissionAction.READ) &&
