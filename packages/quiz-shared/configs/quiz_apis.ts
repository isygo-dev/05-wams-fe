...
const quizApiUrls = {
    ...
    apiUrl_QUIZ_QuizCandidateAnswers_EndPoint:
        apiUrl_QUIZ + api_version + '/private/candidate/quiz/answer/list/submit',
    apiUrl_QUIZ_QuizCandidateAnswer_CompleteAndClean_EndPoint: apiUrl_QUIZ + api_version + '/private/candidate/quiz/complete/clean',
}
