...
const LoginPageView = () => {
  ...
  const tenantFromLocalStorage = typeof localStorage !== 'undefined' ? localStorage.getItem('tenant') : null
  const userNameFromLocalStorage = typeof localStorage !== 'undefined' ? localStorage.getItem('userName') : null

  const defaultValues = {
    tenant: tenantFromLocalStorage !== null ? tenantFromLocalStorage : '',
      ...
      <RightWrapper>
        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            <img
              src='/images/favicon-vertical-logo.png'
