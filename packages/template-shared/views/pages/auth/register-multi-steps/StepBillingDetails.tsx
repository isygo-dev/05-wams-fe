...
// ** Type Import
import {CustomRadioIconsData} from 'template-shared/@core/components/custom-radio/types'
...
const data: CustomRadioIconsData[] = [
    ...
    },
    {
        ...
        content: (
            <Box sx={{my: 'auto', display: 'flex', alignItems: 'center', flexDirection: 'column'}}>
                <Typography sx={{textAlign: 'center', color: 'text.secondary'}}>For small to medium
