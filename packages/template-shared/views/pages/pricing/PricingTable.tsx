...
// ** Types
import {PricingDataType, PricingTableRowType} from 'template-shared/@core/components/plan-details/types'
        ...
        if (typeof row.pro === 'boolean') {
            return (
                <Box sx={{display: 'flex', justifyContent: 'center'}}>
                    <CustomAvatar skin='light' sx={{width: 20, height: 20}}
    ...
    return data && data.pricingTable ? (
        <div>
            <Box sx={{mb: 10, textAlign: 'center'}}>
                ...
                <Typography sx={{color: 'text.disabled'}}>Stay cool, we have a 48-hour money back
                                ...
                                >
                                        ...
                                        <Box sx={{display: 'flex', justifyContent: 'center'}}>
                                            ...
                                            >
                                                <Icon fontSize='0.875rem'
                                                      icon={row.starter ? 'tabler:check' : 'tabler:x'}/>
                                            </CustomAvatar>
                                        </Box>
                                    </TableCell>
                                    ...
                                    <TableCell>
                                        <Box sx={{display: 'flex', justifyContent: 'center'}}>
                                            ...
                                            >
                                                <Icon fontSize='0.875rem'
                                                      icon={row.enterprise ? 'tabler:check' : 'tabler:x'}/>
                                            </CustomAvatar>
                                        </Box>
                                    </TableCell>
                                </TableRow>
