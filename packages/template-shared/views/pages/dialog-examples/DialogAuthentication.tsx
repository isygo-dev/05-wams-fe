...
// ** Hooks
import useBgColor from 'template-shared/@core/hooks/useBgColor'
    ...
    return (
        <Card>
            <CardContent sx={{textAlign: 'center', '& svg': {mb: 2}}}>
                ...
                <Typography sx={{mb: 3}}>Enhance your application security by enabling two factor
                        ...
                        <Grid item xs={12}>
                            {authType === 'sms' ? (
                                <div>
                                    ...
                                    <TextField fullWidth sx={{my: 4}} label='Mobile Number'
                                    ...
                                    <Grid container spacing={6}>
                                        <Grid item xs={12} sx={{display: 'flex', justifyContent: 'flex-end'}}>
                                            ...
                                            <Button variant='contained' endIcon={<Icon icon={arrowIcon}/>}
                                                    onClick={handleAuthDialogClose}>
                                                Continue
                                            </Button>
                                        </Grid>
                                ...
                                <div>
                                    ...
                                    <Box sx={{my: 12, display: 'flex', justifyContent: 'center'}}>
                                        <img width={122} height={122} alt='qr-code'
                                             src='public/images/pages/qr-code.png'/>
                                    </Box>
