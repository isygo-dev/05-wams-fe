...
const steps = [
    ...
    },
    {
        title: 'Address',
        icon: (
            <svg id='wizardCheckoutAddress' width='56' height='56' viewBox='0 0 54 54'
        ...
        icon: (
            <svg id='wizardPayment' width='56' height='56' viewBox='0 0 58 54' xmlns='http://www.w3.org/2000/svg'>
                <g fillRule='nonzero'>
                    ...
                    <path
                        d='m57.575 31.14-5.785-5.785a.965.965 0 0 0-1.365 0L44.64 31.14a.963.963 0 1 0 1.363 1.363l4.14-4.14v24.673a.963.963 0 1 0 1.928 0V28.363l4.14 4.14a.962.962 0 0 0 1.364 0 .963.963 0 0 0 0-1.363z'/>
                </g>
            </svg>
        )
    },
    {
        ...
        icon: (
            <svg id='wizardConfirm' width='56' height='56' viewBox='0 0 58 54' xmlns='http://www.w3.org/2000/svg'>
                <g fillRule='nonzero'>
                    <path
                        d='M7.2 14.4h13.5a.9.9 0 1 0 0-1.8H7.2a.9.9 0 1 0 0 1.8zM7.2 11.7h8.1a.9.9 0 1 0 0-1.8H7.2a.9.9 0 1 0 0 1.8zM21.6 16.2a.9.9 0 0 0-.9-.9H7.2a.9.9 0 1 0 0 1.8h13.5a.9.9 0 0 0 .9-.9z'/>
                    <path
                    ...
                    <path
                        d='M36.9 18h4.127L30.24 28.787l-7.464-7.463a.899.899 0 0 0-1.272 0l-11.34 11.34a.899.899 0 1 0 1.272 1.272L22.14 23.233l7.464 7.463a.898.898 0 0 0 1.272 0L42.3 19.273V23.4a.9.9 0 1 0 1.8 0v-6.3a.897.897 0 0 0-.9-.9h-6.3a.9.9 0 1 0 0 1.8z'/>
                </g>
            </svg>
        )
    }
