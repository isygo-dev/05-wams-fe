                        ...
                        <Grid item md={8} xs={12}>
                            <TabPanel value='cc' sx={{p: 0}}>
                                <Grid container spacing={4}>
                                    <Grid item xs={12}>
                                        <TextField fullWidth type='number' label='Card Number'
                            ...
                            <TabPanel value='cod' sx={{p: 0}}>
                                <Typography sx={{mb: 4}}>
                                    Cash on Delivery is a type of payment method where the recipient make payment for
                                    the order at the
                            ...
                            <TabPanel value='gc' sx={{p: 0}}>
                                ...
                                <Grid container spacing={4}>
                                    <Grid item xs={12}>
                                        <TextField fullWidth type='number' label='Gift Card Number'
                                                   placeholder='Gift Card Number'/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField fullWidth type='number' label='Gift Card Pin'
