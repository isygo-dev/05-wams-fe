...
} from 'template-shared/@core/components/custom-radio/types'
                ...
                <Box sx={{mb: 4, borderRadius: 1, border: theme => `1px solid ${theme.palette.divider}`}}>
                    <CardContent>
                        ...
                        <Box sx={{mb: 4, display: 'flex'}}>
                            <Box sx={{mr: 4}}>
                                <img width={50} src='public/images/products/google-home.png' alt='Google Home'/>
                            </Box>
                            <div>
                        ...
                        <Box sx={{display: 'flex'}}>
                            <Box sx={{mr: 4}}>
                                <img width={50} src='public/images/products/iphone-11.png' alt='iphone 11'/>
                            </Box>
                            <div>
                            ...
                            >
                                ...
                                <Box sx={{display: 'flex', justifyContent: 'flex-end'}}>
                                    <Typography variant='body2'
                                                sx={{mr: 2, textDecoration: 'line-through', color: 'text.disabled'}}>
                                        $5.00
                                    </Typography>
