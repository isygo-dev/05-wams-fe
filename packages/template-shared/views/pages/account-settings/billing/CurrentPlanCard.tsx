...
// ** Types
import {PricingPlanType} from 'template-shared/@core/components/plan-details/types'
                    ...
                    <Grid container spacing={6}>
                        <Grid item xs={12} md={6}>
                            ...
                            <div>
                                ...
                                <Typography sx={{color: 'text.secondary'}}>Standard plan for small to medium
                ...
                >
                    ...
                    <Box sx={{mb: 4, textAlign: 'center'}}>
                        ...
                        <Typography variant='body2'>
                            Get started with us - it's perfect for individuals and teams. Choose a subscription plan
                            that meets your
                            needs.
                        </Typography>
                    </Box>
