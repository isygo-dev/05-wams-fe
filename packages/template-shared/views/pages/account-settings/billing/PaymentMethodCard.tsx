...
import CardWrapper from 'template-shared/@core/styles/libs/react-credit-cards'

// ** Util Import
import {formatCreditCardNumber, formatCVC, formatExpirationDate} from 'template-shared/@core/utils/format'
                                ...
                                {paymentMethod === 'card' ? (
                                    <>
                                        <Grid item xs={12}>
                                            <CreditCardWrapper>
                                                <CardWrapper>
                                                    <Cards cvc={cvc} focused={focus} expiry={expiry} name={name}
                                                           number={cardNumber}/>
                                                </CardWrapper>
                                            </CreditCardWrapper>
                                        </Grid>
                            ...
                            <Grid container spacing={6}>
                                ...
                                <Grid item xs={12}>
                                    <Grid container spacing={6}>
                                        ...
                                        <Grid item xs={12} sm={8}>
                                            <FormControl fullWidth>
                                                <InputLabel id='user-view-billing-edit-card-status-label'>Card
                                                    Status</InputLabel>
                                                <Select
                                                    label='Card Status'
