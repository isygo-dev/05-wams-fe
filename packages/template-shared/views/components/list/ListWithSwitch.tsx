    ...
    return (
        <List subheader={<ListSubheader>Settings</ListSubheader>}>
            ...
            <ListItem>
                ...
                <ListItemSecondaryAction>
                    <Switch edge='end' checked={checked.indexOf('bluetooth') !== -1}
            ...
            <ListItem>
                ...
                <ListItemSecondaryAction>
                    <Switch edge='end' checked={checked.indexOf('location') !== -1}
            ...
            <ListItem>
                ...
                <ListItemSecondaryAction>
                    <Switch edge='end' checked={checked.indexOf('airplane') !== -1}
