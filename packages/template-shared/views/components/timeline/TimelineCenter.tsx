        ...
        <Timeline position={hiddenMD ? 'right' : 'alternate'}>
            <TimelineItem>
                ...
                <TimelineContent sx={{'& svg': {verticalAlign: 'bottom', mx: 4}}}>
                    ...
                    <Typography variant='body2' sx={{color: 'text.primary'}}>
                        <span>Charles de Gaulle Airport, Paris</span> <Icon icon='tabler:arrow-right'
                                                                            fontSize={20}/>{' '}
                        <span>Heathrow Airport, London</span>
                    </Typography>
                    <Typography variant='caption'>6:30 AM</Typography>
                    <Box sx={{mt: 2, display: 'flex', alignItems: 'center'}}>
                        <img width={28} height={28} alt='invoice.pdf' src='public/images/icons/file-icons/pdf.png'/>
            ...
            <TimelineItem>
                ...
                <TimelineContent>
                    ...
                    <Typography variant='body2' sx={{color: 'text.primary'}}>
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus quos, voluptates voluptas
                        rem.
                    </Typography>
                    ...
                    <Box sx={{mb: 3, display: 'flex', flexDirection: {sm: 'row', xs: 'column'}}}>
                        ...
                        <Box sx={{ml: {sm: 3, xs: 0}}}>
                            ...
                            <Typography variant='body2' sx={{mb: 2, color: 'text.primary'}}>
                                PUMA presents the latest shoes from its collection. Light & comfortable made with highly
                                durable
                                material.
                            </Typography>
                        </Box>
