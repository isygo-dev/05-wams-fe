            ...
            case 0:
                return (
                    <Fragment>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor='stepper-custom-horizontal-account-password-2'>Confirm
                                    Password</InputLabel>
                                <OutlinedInput
                ...
                return (
                    <Fragment key={step}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth>
                                <InputLabel
                                    id='stepper-custom-horizontal-personal-multiple-select-label'>Language</InputLabel>
                                <Select
                                    multiple
                                    value={language}
                                    ...
                                    input={<OutlinedInput label='Language'
                                                          id='stepper-custom-horizontal-select-multiple-language'/>}
                                >
