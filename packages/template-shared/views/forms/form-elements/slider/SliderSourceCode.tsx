...
const SliderSuccess = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-active, & .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    0 0 0 10px {hexToRGBA(theme.palette.success.main, 0.16)} !important
  }
}))
...
const SliderError = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-active, & .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    0 0 0 10px {hexToRGBA(theme.palette.error.main, 0.16)} !important
  }
}))
...
const SliderWarning = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-active, & .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    0 0 0 10px {hexToRGBA(theme.palette.warning.main, 0.16)} !important
  }
}))
...
const SliderInfo = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-active, & .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    0 0 0 10px {hexToRGBA(theme.palette.info.main, 0.16)} !important
  }
}))
