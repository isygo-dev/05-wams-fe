...
// ** Types
import {StatusType, UserProfileLeftType} from 'template-shared/@core/types/chat/chatTypes'
                    ...
                    <Box sx={{height: 'calc(100% - 13.3125rem)'}}>
                        <ScrollWrapper>
                            <Box sx={{p: 6}}>
                                ...
                                <TextField minRows={4} multiline fullWidth sx={{mb: 6}}
                                ...
                                <RadioGroup value={userStatus} sx={{mb: 6, ml: 0.8}} onChange={handleUserStatus}>
                                    ...
                                    <div>
                                        <FormControlLabel value='away' label='Away'
