        ...
        <Card>
                            ...
                            <Table sx={{maxWidth: '210px'}}>
                                <TableBody sx={{'& .MuiTableCell-root': {py: `${theme.spacing(1.5)} !important`}}}>
                                    <TableRow>
                                        ...
                                        <MUITableCell>
                                            <Typography variant='h6'>{`#11111`}</Typography>
                                        </MUITableCell>
                                    </TableRow>
                                    <TableRow>
                                        <MUITableCell>
                                        ...
                                        <MUITableCell>
                                            <Typography
                                                sx={{fontWeight: 500, color: 'text.secondary'}}>issuedDate</Typography>
                                        </MUITableCell>
                                    </TableRow>
                                    <TableRow>
                                        <MUITableCell>
                                        ...
                                        <MUITableCell>
                                            <Typography
                                                sx={{fontWeight: 500, color: 'text.secondary'}}>dueDate</Typography>
                                        </MUITableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
            ...
            <CardContent sx={{p: [`${theme.spacing(6)} !important`, `${theme.spacing(10)} !important`]}}>
                <Grid container>
                    <Grid item xs={12} sm={6} sx={{mb: {lg: 0, xs: 4}}}>
                        ...
                        <Typography sx={{mb: 1.5, color: 'text.secondary'}}>contact</Typography>
                        <Typography sx={{mb: 1.5, color: 'text.secondary'}}>companyEmail</Typography>
                    </Grid>
                                ...
                                <Table>
                                    <TableBody sx={{'& .MuiTableCell-root': {py: `${theme.spacing(0.75)} !important`}}}>
                                        ...
                                        <TableRow>
                                            ...
                                            <MUITableCell>
                                                <Typography sx={{color: 'text.secondary'}}>bankName</Typography>
                                            </MUITableCell>
                                        </TableRow>
                                        <TableRow>
                                            <MUITableCell>
                                        ...
                                        <TableRow>
                                            ...
                                            <MUITableCell>
                                                <Typography sx={{color: 'text.secondary'}}>swiftCode</Typography>
                                            </MUITableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
            ...
            <TableContainer>
                <Table>
                    ...
                    <TableBody
                        sx={{'& .MuiTableCell-root': {fontSize: '1rem', py: `${theme.spacing(2.5)} !important`}}}>
                        <TableRow>
