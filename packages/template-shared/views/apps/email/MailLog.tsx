                        ...
                        <Box sx={{display: 'flex', alignItems: 'center'}}>
                            ...
                            {store && store.selectedMails.length && store.mails && store.mails.length ? (
                                <Fragment>
                                    ...
                                    <OptionsMenu leftAlignMenu options={handleFoldersMenu()}
                                                 icon={<Icon icon='tabler:folder'/>}/>
                                    <OptionsMenu leftAlignMenu options={handleLabelsMenu()}
                                ...
                                {store.mails.map((mail: MailType) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                {routeParams && routeParams.folder !== 'trash' ? (
                                                    <Tooltip placement='top' title='Action.Delete'>
                                                        <IconButton
                                                            onClick={e => {
                                                                e.stopPropagation()
                                                                dispatch(updateMail({
                                            ...
                                            >
                                                ...
                                                }}>{renderMailLabels(mail.labels)}</Box>
                                                <Typography
                                                    variant='body2'
                                                    sx={{
                                                        minWidth: '50px',
