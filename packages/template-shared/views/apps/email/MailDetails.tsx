...
import Sidebar from 'template-shared/@core/components/sidebar'
...
import {OptionType} from 'template-shared/@core/components/option-menu/types'
import {
    MailAttachmentType,
    MailDetailsType,
    MailFoldersArrType,
    MailLabelType,
    MailType
} from 'template-shared/@core/types/helper/emailTypes'
                            ...
                            <div>
                                ...
                                {mail.replies.length ? (
                                    <IconButton size='small'
                                        ...
                                        {showReplies ? <Icon icon='tabler:fold'/> :
                            ...
                            >
                                                    ...
                                                    >
                                                        <Box sx={{display: 'flex', alignItems: 'center'}}>
                                                            ...
                                                            <Box sx={{display: 'flex', flexDirection: 'column'}}>
                                                                <Typography
                                                                    sx={{fontWeight: 500}}>{reply.from.name}</Typography>
                                                                        ...
                                                                        <ListItem disableGutters key={item.fileName}>
                                                                            <ListItemIcon sx={{mr: 2}}>
                                                                                <img src={item.thumbnail}
                                                                                     alt={item.fileName} width='24'
                                                                                     height='24'/>
                                                                            </ListItemIcon>
                                                                            <Typography
                                                                                sx={{color: 'text.secondary'}}>{item.fileName}</Typography>
                                                                        </ListItem>
                                                                    )
                                                                })}
                                                            </List>
                                ...
                                {mail.replies.length && !showReplies ? (
                                    <Fragment>
                                        ...
                                        <HiddenReplyFront sx={{cursor: 'pointer'}}
                                                          onClick={() => setShowReplies(true)}/>
                                    </Fragment>
                                ) : null}
