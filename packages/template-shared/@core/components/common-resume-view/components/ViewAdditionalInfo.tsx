...
const ViewAdditionalInfo: React.FC<{ candidateName: string }> = ({candidateName}) => (
    <Card sx={{height: '100%'}}>
        ...
        <CardContent>
            ...
            <Button variant='contained' color='primary' className={'button-padding-style'} sx={{marginTop: 2}}
                    size={'small'}>
                View tests
            </Button>
        </CardContent>
