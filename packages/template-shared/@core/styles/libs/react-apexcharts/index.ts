...
const ApexChartWrapper = styled('div')(({ theme }) => ({
  '& .apexcharts-canvas': {
    ...
    '& .apexcharts-xaxistooltip': {
      borderColor: theme.palette.divider,
      background: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#F8F7FA',
      '&:after': {
        borderBottomColor: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#F8F7FA'
      },
      '&:before': {
    ...
    '& .apexcharts-yaxistooltip': {
      ...
      background: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#F8F7FA',
      '&:after': {
        borderLeftColor: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#F8F7FA'
      },
      '&:before': {
