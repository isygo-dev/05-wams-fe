...
const restoreSettings = (): Settings | null => {
    ...
    try {
        const storedData: string | null = window.localStorage.getItem(localStorageKeys.settings)
...
const storeSettings = (settings: Settings) => {
    ...
    window.localStorage.setItem(localStorageKeys.settings, JSON.stringify(initSettings))
}
