...
COPY ./apps/wams-smekit-fe/docker-dev.env ./apps/wams-smekit-fe/.env
...
RUN pnpm turbo run build:docker-dev --filter=apps/wams-smekit-fe...
...
CMD ["pnpm", "turbo", "run", "start:docker-dev", "--filter=apps/wams-smekit-fe..."]